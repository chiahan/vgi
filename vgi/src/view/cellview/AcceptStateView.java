 ...
 *  Line sawtooth
 */
public class AcceptStateView extends VertexView {
    ...
    /**
     */
    public AcceptStateView(Object cell) {
        super(cell);
    }
    ...
    public static class StateRenderer extends VertexRenderer {
        ...
        public void paint(Graphics g) {
            ...
            int xpoints_2[] = {width+width/6, width+width/3, width+width/6};
            int ypoints_2[] = {height /4, height / 2, 3*height /4};
            int npoints_2 = 3;
            g.fillPolygon(xpoints_2,ypoints_2,npoints_2);
            g.drawLine(width, height / 2, width/3+width, height / 2);
            
            if (bordercolor != null) {
                g.setColor(bordercolor);
                g2.setStroke(new BasicStroke(b));
                 g.drawOval(0,0, width-b ,height-b);
