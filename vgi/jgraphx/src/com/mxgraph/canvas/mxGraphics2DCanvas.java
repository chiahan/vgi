...
public class mxGraphics2DCanvas extends mxBasicCanvas
{
	 ...
	 * 
	 */
	public static final String TEXT_SHAPE_CURVE="curve";
	...
	static
	{
		...
		putTextShape(TEXT_SHAPE_HTML, new mxHtmlTextShape());
                ...
                putTextShape(TEXT_SHAPE_CURVE, new mxCurveLabelShape(null,null));
	...
	public mxITextShape getTextShape(Map<String, Object> style, boolean html)
	{
        ...
        /**
         * new
         * get text shape:default or curved
         */
        public mxITextShape getTextShape(Map<String, Object> style)
	{
		String name=(String) style.get("textShape");
                return textShapes.get(name);
	}
